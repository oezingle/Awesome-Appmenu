...
local gtk_menu_item = require("a0e6c2e1-f66a-4a00-838a-f9bb0808f5ad.src.menu_provider.gtk.item")
...
local spawn = require("a0e6c2e1-f66a-4a00-838a-f9bb0808f5ad.dep.src.agnostic.spawn.promise")
